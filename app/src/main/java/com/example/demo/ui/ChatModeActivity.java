...
public class ChatModeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRequestQueue = Volley.newRequestQueue(ChatModeActivity.this);
        ...
        sendMsgIB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userMsgEdt.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(ChatModeActivity.this, "Please enter your message..", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ChatModeActivity.this, RecyclerView.VERTICAL, false);
    ...
    private void sendMessage(String userMsg) {
        ...
        RequestQueue queue = Volley.newRequestQueue(ChatModeActivity.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ChatModeActivity.this, "No response from the bot..", Toast.LENGTH_SHORT).show();
            }
        });
